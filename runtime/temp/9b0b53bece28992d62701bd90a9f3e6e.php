<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpStudy\WWW\tp5\public/../application/admin\view\admin\admin-list.html";i:1552543778;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php echo date("Y-m-d H:i:s",$vo['upd_time']); ?>
                        </td>
                        <td class="td-status">
